...
class EdgeShapesAndStaticBodiesTest : public Test
{
public:
    EdgeShapesAndStaticBodiesTest()
    {
        // 랜덤 시드 초기화
    ...
    static Test* Create()
    {
        return new EdgeShapesAndStaticBodiesTest;
    }
};

static int testIndex = RegisterTest("Custom", "Edge Shapes02", EdgeShapesAndStaticBodiesTest::Create);
